import {
  linear,
  sqrt
} from "./chunk-7KYGBWLV.js";
import {
  stack_default
} from "./chunk-SJGFOJJG.js";
import "./chunk-MQALVCIK.js";
import {
  InternSet,
  ascending,
  bin
...
import "./chunk-GBWESI6U.js";
import {
  derived,
  writable
} from "./chunk-UHSBZHGB.js";
...
function ScaledSvg($$anchor, $$props) {
  ...
  template_effect(() => {
    ...
    set_style(svg, "z-index", zIndex());
    set_style(svg, "pointer-events", strict_equals(pointerEvents(), false) ? "none" : null);
    set_style(svg, "top", $padding().top + "px");
    set_style(svg, "left", $padding().left + "px");
    set_style(svg, "width", `calc(100% - ${$padding().left + $padding().right}px)`);
    set_style(svg, "height", `calc(100% - ${$padding().top + $padding().bottom}px)`);
  });
  append($$anchor, svg);
  return pop({ ...legacy_api() });
}
...
function Canvas($$anchor, $$props) {
  ...
  template_effect(() => {
    ...
    set_style(canvas, "z-index", zIndex());
    set_style(canvas, "pointer-events", strict_equals(pointerEvents(), false) ? "none" : null);
    set_style(canvas, "top", $padding().top + "px");
    set_style(canvas, "right", $padding().right + "px");
    set_style(canvas, "bottom", $padding().bottom + "px");
    set_style(canvas, "left", $padding().left + "px");
  });
  append($$anchor, fragment);
  return pop({ ...legacy_api() });
}
